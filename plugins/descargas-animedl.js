...
let handler = async (m, { conn, args, usedPrefix, text, command }) => {
    ...
    try {
        ...
        m.reply(`_Nota: Ten en cuenta que los animes en emisión solo duran 3 días en la nube por lo que no se descargará después de ese lapso de tiempo. gracias por usar a Yuki Suou 🍁_`);
