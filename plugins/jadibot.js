...
case isCommand2:
if (global.conn.user.jid == conn.user.jid) conn.reply(m.chat, `🌸 Si no es *Sub-Bot* comuníquese al numero principal del *Bot* para ser *SubBot*`, m)
else {
await conn.reply(m.chat, `🍬 YukiBot desactivada.`, m)
conn.ws.close()}  
break
