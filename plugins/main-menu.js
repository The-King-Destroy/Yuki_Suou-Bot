...
const defaultMenu = {
  before: `Hola %taguser 👋, Soy Yuki-Suou-Bot
...
await conn.sendMessage(m.chat, { image: { url: img.getRandom() }, caption: text.trim(), contextInfo: { mentionedJid: [m.sender], isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, newsletterName: channelRD.name, serverMessageId: -1, }, forwardingScore: 999, externalAdReply: { title: '🍬 ↫ Yυƙι-Sυσυ-Bσƚ ↬ 🍬', body: dev, thumbnailUrl: perfil, sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false,
