...
global.packsticker =`°.⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ`
global.packsticker2 = `⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸.°\n✦ Bσƚ: ⪛✰ 𝐘𝐮𝐤𝐢-𝐒𝐮𝐨𝐮-𝐁𝐨𝐭 ✰⪜\n✦ Pɾσριҽƚαɾισ: ⁱᵃᵐ|𝔇ĕ𝐬†𝓻⊙γ𒆜}\n✦ Fҽƈԋα ԃҽ Cɾҽαƈιóɳ: ${moment.tz('America/Los_Angeles').format('DD/MM/YY')}\n✦ Hσɾα ԃҽ Cɾҽαƈιóɳ: ${moment.tz('America/Los_Angeles').format('HH:mm:ss')}\n✦ Aυтσɾ: @${conn.getName(m.sender)}\n°.⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸⎯ܴ⎯̶᳞͇ࠝ⎯⃘̶⎯̸.°\n\nѕτιϲκєя ϐγ: Yυƙι-Sυσυ-Bσƚ`
