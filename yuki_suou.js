...
console.log('🌷 Yuki Ai no tiene Sub-Bots vinculados.');
return;
}
...
console.log(chalk.bold.greenBright(`🌷 Yuki Ai conectada correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🥀 Error al iniciar a Yuki Ai: `, error))
}
})();
